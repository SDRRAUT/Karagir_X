...
const ROLE_CONTENT: Record<UserRole, RoleContent> = {
  ...
  FACILITATOR: {
    tag: 'SAHYOGI DESK',
    title: 'Artisans ko support karne ka\nsafar shuru karein',
    subtitle: 'Apna mobile number ya email enter karein aur cluster ko empower karein.',
    avatar3D: require('@/../assets/sahyogi_3d_avatar.jpg'),
    themeColor: '#16A34A',
    lightBg: '#F0FDF4',
    borderAccent: '#BBF7D0',
    demoPhone: '9822399887',
    demoEmail: 'sahyogi.demo@kalakarsetu.com',
    voicePrompt: 'कृपया अपना मोबाइल नंबर या ईमेल दर्ज करें और सहायता केंद्र से जुड़ें।',
  },
  ADMIN_STAFF: {
    tag: 'OPERATIONS DESK',
    title: 'Kalakar Setu Operations',
    subtitle: 'Apna verified staff credentials enter karein.',
    avatar3D: require('@/../assets/sahyogi_3d_avatar.jpg'),
    themeColor: '#0F172A',
    lightBg: '#F1F5F9',
    borderAccent: '#CBD5E1',
    demoPhone: '9800011223',
    demoEmail: 'admin.staff@kalakarsetu.com',
    voicePrompt: 'कृपया अपना अधिकृत स्टाफ क्रेडेंशियल्स दर्ज करें।',
  },
};
